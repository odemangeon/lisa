...
datasetnames = [f"LC_{obj_name}_CHEOPS_{100}"]  # [f'RV_{obj_name}_SOPHIEp_0', f'RV_{obj_name}_SOPHIE_0', f'RV_{obj_name}_ELODIE_0', ]  #

row4datasetname = {f"LC_{obj_name}_CHEOPS_{100 + ii}": 0 for ii in range(1)}
# for ii in range(15, 20):
#     row4datasetname[f"LC_{obj_name}_CHEOPS_{100 + ii}"] = 1
pl_kwargs = {f"LC_{obj_name}_CHEOPS_{100 + ii}": {'data': {'fmt': '.', 'color': 'k', 'alpha': 0.05, 'label': None}, } for ii in range(1)}
