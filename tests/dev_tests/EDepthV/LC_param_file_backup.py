...
phasecurve_model = {'b': {'do': True,
                          'model4instrument': {'LC_CHEOPS_inst0': ['0'],
                                               ...
                                               'LC_CHEOPS_inst18': ['18'],
                                               'LC_CHEOPS_inst19': ['19'],},
                          'model_definitions': {'0': {'args': {'factor_period': 1,
                                                               'flux_offset': 'param',
                                                               'occultation': True,
                                                               'phase_offset': 'param',
                                                               'sincos': 'cos'},
                                                      'category': 'sincos',
                                                      'param_extensions': {'planet': {'A': '0',
                                                                                      'Foffset': '',
                                                                                      'Phi': ''},
                                                                           'star': {}}},
