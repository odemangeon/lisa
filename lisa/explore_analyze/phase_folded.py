...
def create_phasefolded_plots(post_instance, df_fittedval,
                ...
                if is_planet:
                    if (datasetnameformodel4row[i_row] == datasetname) or (datasetnameformodel4row[i_row] == 'all'):
                        ...
                        (computed_models_4_PF[planetorperiod_name][datasetname], pl_kwarg_final
                                                   ...
                                                   remove_add_model_components_func=remove_add_model_components_func,
                                                   key_pl_kwarg="model",
                                                   remove_dict=remove_dict, add_dict=add_dict, compute_only_raw_models=False,
                    ...
                    (computed_models_4_PF[planetorperiod_name][datasetname], pl_kwarg_final
                                                ...
                                                fact_tsim_to_xsim=None, xsim=None, time_unit=None,
                                                plot_unbinned=False, plot_binned=False, ax=None, pl_kwarg=None, key_pl_kwarg=None,
                                                models=dico_load["models"][datasetname], get_key_compute_model_func=get_key_compute_model_func,
                                                kwargs_get_key_compute_model=kwargs_get_key_compute_model,
                                                )
    ...
    return (dico_load, kwargs_compute_model_4_key_model), computed_models_4_PF
