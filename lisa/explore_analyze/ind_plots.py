...
def create_IND_TSNGLSP_plots(fig, post_instance, df_fittedval, IND_subcat, datasim_kwargs=None,
    ...
    return create_TSNGLSP_plots(fig=fig, post_instance=post_instance, df_fittedval=df_fittedval,
                                ...
                                d_name_component_removed_to_print=d_name_component_removed_to_print,
                                show_dict=show_dict, l_model_1_per_row=['model', 'model_wGP', 'sys_var', 'GP'],
                                datasetnames4model4row=datasetname4model4row,
                                datasim_kwargs=datasim_kwargs,
...
def create_IND_iTSNGLSP_plots(fig, post_instance, df_fittedval, IND_subcat, datasim_kwargs=None,
                             ...
                             create_axes_kwargs=None,
                             suptitle_kwargs=None,
                             IND_fact=1., IND_unit="$km/s$",
                             fontsize=AandA_fontsize
                             ):
    """Produce clean iterative IND time series and generalized Lomb-Scargle plots of a system.
    ...
    return create_iTSNGLSP_plots(fig=fig, post_instance=post_instance, df_fittedval=df_fittedval,
                                 ...
                                 d_name_component_removed_to_print=d_name_component_removed_to_print,
                                 l_1_model_4_alldst=['model', 'model_wGP', 'sys_var', 'GP'],
