...
class GravGroup_Parametrisation(Core_Parametrisation):
    ...
    def apply_parametrisation(self, **kwargs):
        ...
        super(GravGroup_Parametrisation, self).apply_parametrisation(**kwargs)
    ...
    #         for star in self.paramcontainers["stars"].values():
    ...
    #     if RV_inst_cat in set(self.dataset_db.inst_categories):
    #         for inst_model in self.get_instmodel_objs(inst_fullcat=RV_inst_cat):
    #             inst_model.apply_parametrisation()
    #     if LC_inst_cat in set(self.dataset_db.inst_categories):
    #         for inst_model in self.get_instmodel_objs(inst_fullcat=LC_inst_cat):
    #             inst_model.apply_parametrisation()
    #
    ...
    #             for inst_model in self.get_instmodel_objs(inst_fullcat=inst_fullcat_i):
    #
