...
def lnprior_ind(p):
    ...
    if not  23.26918 - 0.02765*5 < t0 < 23.26918 +0.03515*5.0:  # extrapolation gives 7399.46948  0.08 is an error of 2 hours
        return -np.inf
    #if not  7.92008 - 0.0013*3 < period1 < 7.92008 + 0.0013*3: # error in the paper is 0.6 minutes i am allowng 2 minutes=0.0013
    #    return -np.inf
