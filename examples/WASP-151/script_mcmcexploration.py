...
logger.info("4. Define the instrument models.")
post_instance.load_instrumentmodelsfile("instrument_models.py")  # Change if needed by the name you gave or want to give to your dataset file.

logger.info("5. Define the noise models.")
post_instance.load_noisemodelsfile("noise_models.py")  # Change if needed by the name you gave or want to give to your dataset file.

logger.info("6. Add a model")
